...
function et_builder_load_modules_styles() {
	...
	wp_register_script( 'google-maps-api', esc_url( add_query_arg( array( 'key' => AIzaSyCziuB9ZgoyQZLGWam7CF8Tj8y97iqtu_k ), is_ssl() ? 'https://maps-api-ssl.google.com/maps/api/js' : 'http://maps.google.com/maps/api/js' ) ), array(), ET_BUILDER_VERSION, true );
