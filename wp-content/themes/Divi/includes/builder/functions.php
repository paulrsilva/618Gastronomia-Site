...
if ( ! defined( 'ET_BUILDER_PRODUCT_VERSION' ) ) {
	...
	define( 'ET_BUILDER_PRODUCT_VERSION', 2.7 );
}
...
function et_pb_add_builder_page_js_css(){
	...
	wp_enqueue_script( 'google-maps-api', esc_url( add_query_arg( array( 'key' => AIzaSyCziuB9ZgoyQZLGWam7CF8Tj8y97iqtu_k), is_ssl() ? 'https://maps-api-ssl.google.com/maps/api/js' : 'http://maps.google.com/maps/api/js' ) ), array(), '3', true );
